...
export const LandingPage: React.FC<LandingPageProps> = ({ onStart }) => {
  // Simulated preview values fluctuating on timer
  const [moisture, setMoisture] = useState(72.4);
  const [temp, setTemp] = useState(21.8);
  const [humidity, setHumidity] = useState(81.2);
